    ...
    async TestResutl ({ request, response }) {
        ...
        for (let index = 0; index < testList.length; index++) {
            let _testInfo = {
                ...
                utm_source: testList[index].utm_source,
                utm_medium: testList[index].utm_medium,
                utm_campaign: testList[index].utm_campaign,
                utm_term: testList[index].utm_term,
